            ...
            <div class="box box-default">
                ...
                <div class="box-body no-padding" style="display: block;">
                    <ul class="nav nav-pills nav-stacked">
                        <li><?= $this->Html->link(__('Reporte CDPs'), ['action' => 'index', '?' => ['state-id' => @$state_id]]) ?></li>
                    </ul>
                </div>
                <!-- /.box-body -->
            </div>
...
function addItemsTable(add_item){
    ...
    $(".table-items tbody").append("<tr><td>"+add_item.itemstypes.name+"</td><td>"+add_item.classifications.name+"</td><td>"+add_item.items.name+"</td><td>"+add_item.resources.name+"</td><td>"+tasks+"</td><td class=\'valueFormat\'>"+add_item.value+"</td></tr>");    
