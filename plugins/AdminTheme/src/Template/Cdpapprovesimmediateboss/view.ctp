...
<?php $this->append('script', $this->Html->script(['NumeroALetras', 'jquery-number/jquery.number.min', 'cdpapprovesimmediateboss/view'])); ?>
<?= $this->append('script', '<script type="text/javascript">
    base_url = "' . $this->Url->build('/cdpapprovesimmediateboss/', true) . '";
