...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="div_task" style="display: none"> tareas a enviar</div>
...
<?php $this->append('script', $this->Html->script(['NumeroALetras', 'jquery-number/jquery.number.min', 'cdpapprovesplanningconsultant/view'])); ?>
<?= $this->append('script', '<script type="text/javascript">
    base_url = "' . $this->Url->build('/cdpapprovesplanningconsultant/', true) . '";
