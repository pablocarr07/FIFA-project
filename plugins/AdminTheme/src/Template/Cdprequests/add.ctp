  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box box-default">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><?= __('Nueva Solicitud de CDP ')?></h3>
        </div>
        <!-- /.box-header -->
            ...
            <?= $this->Form->create($cdprequest); ?>
              ...
              <div class="box-body">
                ...
                <table class="table table-bordered table-items">
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="4"><sup><b>Son.</b> </sup> <span class="totalItemsLetters"> </span></td>
...
<?php
  ...
  $this->append('script', $this->Html->script(['NumeroALetras','jquery-number/jquery.number.min','cdprequests/add']));
