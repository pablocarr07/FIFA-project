              ...
              <tbody>
                <?php foreach ($cdprequests as $cdprequest) : ?>
                  ...
                  <td class="actions">
                    ...
                    <?= $this->Html->link('<span class="glyphicon glyphicon-eye-open"></span><span class="sr-only">' . __('Ver') . '</span>', ['action' => 'view', '?' => ['state-id' => $state_id, 'id' => $cdprequest->id]], ['escape' => false, 'class' => 'btn btn-xs', 'data-toggle' => 'tooltip', 'title' => __('Ver')]) ?>
                    <?php if ($state_id == '0' or $state_id == '2') { ?>
                      <?= $this->Html->link('<span class="glyphicon glyphicon-pencil"></span><span class="sr-only">' . __('Editar') . '</span>', ['action' => 'edit', '?' => ['state-id' => $state_id, 'id' => $cdprequest->id]], ['escape' => false, 'class' => 'btn btn-xs', 'data-toggle' => 'tooltip', 'title' => __('Editar')]) ?>
                      <?= $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span><span class="sr-only">' . __('Eliminar') . '</span>', ['action' => 'delete', '?' => ['state-id' => $state_id, 'id' => $cdprequest->id]], ['confirm' => __('Are you sure you want to delete # {0}?', $cdprequest->id), 'escape' => false, 'class' => 'btn btn-xs', 'data-toggle' => 'tooltip', 'title' => __('Eliminar')]) ?>
