            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="pull">
                        ...
                        <?= $this->Html->link('<span class="glyphicon glyphicon-time"></span><span class="sr-only">'
                            . __('Aplazar') . '</span>', ['action' => '#'], ['escape' => false, 'class' => 'btn btn-lg btn-warning accion', 'id' => 'aplazar', 'title' => __('Aplazar')]) ?>
                    ...
                    <div class="row">
                        <div class="aprobar">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <?= $this->Form->input('cdp', array('label' => 'Número Cdp', 'type' => 'numeric', 'value' => '')); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <?= $this->Form->input('soprtecdp_file', array('type' => 'file', 'label' => 'Soporte Cdp', 'required' => FALSE)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<?php $this->append('script', $this->Html->script(['NumeroALetras', 'jquery-number/jquery.number.min', 'cdpapprovesfinancialcoordinator/view'])); ?>
<?= $this->append('script', '<script type="text/javascript">
    base_url = "' . $this->Url->build('/cdpapprovesfinancialcoordinator/', true) . '";
