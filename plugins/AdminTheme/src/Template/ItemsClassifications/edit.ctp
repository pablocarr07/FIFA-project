<section class="content">
  <div class="row">
    <div class="col-md-3">
      <div class="box box-default">
        ...
        <div class="box-body no-padding" style="display: block;">
          <ul class="nav nav-pills nav-stacked">
            <li>
              ...
              <li class="active"><?= $this->Html->link(__('Editar'), ['action' => 'edit', $itemsClassification->id]) ?> </li>
              <li><?= $this->Html->link(__('Ver'), ['action' => 'view', $itemsClassification->id]) ?> </li>
        ...
        <div class="col-md-9">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title"><?= __('Editar Cuentas o Proyectos')?> </h3>
            </div>
            ...
            <div class="box-body">
              <div class="pull">
                <?= $this->Form->create($itemsClassification); ?>
                  <?php
                  echo $this->Form->input('parent_id', ['options' => $parentItemsClassifications, 'class' => 'parentItemsClassifications', 'empty' => '(Elegir Padre)', 'label'=>'Padre', 'onchange' => 'javascript:cambio(this);']);
                  echo $this->Form->input('name',['label'=>'Nombre']);
                  echo $this->Form->input('item_type_id',['options' => $itemsTypes, 'class' => 'lstItemType', 'empty'=>'(Elegir Clase de Gasto)', 'label'=>'Clase de Gasto']);
                  ?>
    ...
    function inicio() {
      console.log($('.parentItemsClassifications').val());
      if ($('.parentItemsClassifications').val() != '') {
        cambio($('.parentItemsClassifications').val())
      }
    }
