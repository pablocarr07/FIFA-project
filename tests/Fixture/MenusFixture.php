...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'visible' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'lft' => 1,
            'rght' => 1,
            'created' => '2016-07-04 15:21:42',
            'modified' => '2016-07-04 15:21:42',
            'deleted' => '2016-07-04 15:21:42'
        ],
    ];
}
