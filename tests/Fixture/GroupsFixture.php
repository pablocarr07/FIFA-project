...
class GroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dependency_id' => ['type' => 'integer', 'length' => 5, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'dependency' => ['type' => 'index', 'columns' => ['dependency_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'dependency' => ['type' => 'foreign', 'columns' => ['dependency_id'], 'references' => ['dependencies', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'lft' => 1,
            'rght' => 1,
            'created' => '2016-06-16 10:23:32',
            'modified' => '2016-06-16 10:23:32',
            'deleted' => '2016-06-16 10:23:32'
        ],
    ];
}
