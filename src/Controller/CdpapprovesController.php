...
class CdpapprovesController extends AppController {
    ...
    public function initialize() {
        ...
        $this->query = $this->Fifa->Cdprequests()->Cdprequests_aprobacion_solicitante();
    }
    ...
    public function view($id = null) {
        ...
        $query = $this->query->where(array('Cdprequests.applicant_id' => $this->Auth->user('id'), 'Cdprequests.state' => 3, 'Cdprequests.id' => $id));
        if ($query->count() > 0) {
    ...
    public function approve() {
        $output = $this->action(3, 4, 'aprobar');
